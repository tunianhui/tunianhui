    ...
    <div class="pr-15 pl-15">
      <el-form :model="apiAttrForm"
        ...
        <el-form-item label="API 名称"
                      prop="api_name">
          <el-input v-if="flag==='add' || flag==='edit'"
                    v-model="apiAttrForm.api_name"
                    maxlength="60"
                    show-word-limit
                    placeholder="支持汉字，数字，英文，下划线，且只能以英文或汉字开头，4~50个字符"></el-input>
          <span v-if="flag==='detail'">{{apiAttrForm.api_name}}</span>
        </el-form-item>
        <el-form-item label="API 分组"
                      prop="api_group">
          <el-select v-model="apiAttrForm.api_group"
                     placeholder="请选择API分组"
                     v-if="flag==='add'||flag==='edit'">
            <el-option :label="item.group_name"
                       :value="item.group_name"
                       v-for="item in apiGroupList"
                       :key="item.group_name"></el-option>
          </el-select>
        ...
        <el-form-item label="协议"
                      prop="api_protocol">
          <el-checkbox-group v-model="apiAttrForm.api_protocol"
                             v-if="flag==='add' || flag==='edit'">
            <el-checkbox label="http"
                         name="api_protocol"></el-checkbox>
        ...
        <el-form-item label="请求方式"
                      prop="api_request_type">
          <el-select v-model="apiAttrForm.api_request_type"
                     placeholder="请选择请求方式"
                     v-if="flag==='add' || flag==='edit'">
            <el-option label="GET"
        ...
        <el-form-item label="返回类型"
                      prop="api_reponse_type">
          <el-select v-model="apiAttrForm.api_reponse_type"
                     placeholder="请选择返回类型"
                     v-if="flag==='add' || flag==='edit'">
            <el-option label="JSON"
        ...
        <el-form-item label="描述"
          ...
          <el-input type="textarea"
                    v-model="apiAttrForm.api_remark"
                    maxlength="2000"
                    show-word-limit
                    rows="5"
                    v-if="flag==='add' || flag==='edit'"></el-input>
        ...
        <el-form-item label="sql"
          ...
          <MonacoEditor style="height: 200px"
                        :code.sync="apiAttrForm.sql_template"></MonacoEditor>
        </el-form-item>
      </el-form>
    </div>
  </section>
