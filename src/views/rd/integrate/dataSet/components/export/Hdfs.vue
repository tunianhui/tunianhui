 ...
 * @LastEditTime: 2023-08-08 14:37:36
 * @Description:
-->
  ...
  <div class="comp-option-three">
    ...
    <el-form ref="form" label-width="100px" :model="form" :rules="rules" label-suffix="：">
      <el-row :gutter="20">
        ...
        <el-col :span="12" v-if="form.fileType === 'text'||form.fileType === 'csv'">
        ...
        <el-col :span="12">
          <el-form-item label="导出表头" prop="tabHeader">
            <el-select v-model="form.tabHeader" placeholder="请选择">
...
export default {
  ...
  data () {
    return {
      rules: {
        ...
        path: [{ required: true, message: '请输入', trigger: ['change', 'blur'] }],
        fileType: [{ required: true, message: '请选择', trigger: ['change', 'blur'] }],
        fieldDelimiter: [{ required: true, message: '请输入', trigger: ['change', 'blur'] }],
        encoding: [{ required: true, message: '请输入', trigger: ['change', 'blur'] }],
        compressType: [{ required: true, message: '请选择', trigger: ['change', 'blur'] }],
        batchSize: [{ required: true, message: '请选择', trigger: ['change', 'blur'] }],
        tabHeader: [{ required: true, message: '请选择', trigger: ['change', 'blur'] }],
  ...
  methods: {
    ...
    async configData () {
      const dictCodes = ['HDFSWRITER_WRITEMODE', 'HDFSWRITER_FILETYPE', 'HDFSWRITER_COMPRESSTYPE']
      ...
      this.compressTypeList = results[2].data
    },
