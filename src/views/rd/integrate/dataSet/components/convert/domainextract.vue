 ...
 * @LastEditTime: 2023-07-31 14:24:43
 * @Description: 字符串拼接
-->
  ...
  data () {
    return {
      ...
      processingMethodList: [
        { name: '取主域名(firstdomain)', value: 1 },
        { name: '取子域名(seconddomain)', value: 2 },
        { name: '取n级域名(levelIddomain)', value: 3 },
        { name: '取顶级域名(topdomain)', value: 4 },
        { name: '取域名后缀(domainsuffix)', value: 5 }
      ]
    }
  },
  created () {
