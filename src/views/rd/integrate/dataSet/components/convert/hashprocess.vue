 ...
 * @LastEditTime: 2023-07-31 14:37:20
 * @Description: 字符串拼接
-->
  ...
  data () {
    return {
      ...
      processingMethodList: [
        { name: 'MD5 哈希值', value: 1 },
        { name: 'SHA-1 哈希值', value: 2 },
        { name: 'SHA-224 哈希值', value: 3 },
        { name: 'SHA-256 哈希值', value: 4 },
        { name: 'SHA-384 哈希值', value: 5 },
        { name: 'SHA-512 哈希值', value: 6 }
      ]
    }
  },
  created () {
