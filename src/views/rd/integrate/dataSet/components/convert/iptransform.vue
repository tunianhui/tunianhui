 ...
 * @LastEditTime: 2023-07-31 14:19:53
 * @Description: 字符串拼接
-->
  ...
  data () {
    return {
      ...
      processingMethodList: [
        { name: 'IP转数值(ipstr2long)', value: 1 },
        { name: '数值转IP(long2ipstr)', value: 2 },
        { name: 'IPv6转数值(ipv6tolongstr)', value: 3 },
        { name: '数值转IPv6(longstr2ipv6)', value: 4 }
      ]
    }
  },
  created () {
