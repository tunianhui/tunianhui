 ...
 * @LastEditors: 大炸鹅
 * @LastEditTime: 2023-07-04 11:04:30
 * @FilePath: \dataphin\src\views\rd\operation-new\component\search-item.vue
-->
<template>
        ...
        <div class="item" :key="itemData.key + ''" v-if="itemData.show">
          ...
          <div class="filter-item-content">
            <div class="task-type">
              ...
              <template v-if="itemData.type === 'select-one'">
                <el-select v-model="itemData[itemData.key]" placeholder="请选择" style="width:100%" class="not-border border-r">
                  <el-option
                    v-for="item in itemData.options"
                    :key="item.value"
                    :label="item.label"
