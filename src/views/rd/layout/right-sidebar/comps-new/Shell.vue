 ...
 * @Author: YONG
 * @LastEditors: YONG
 * @Date: 2023-01-10 14:35:18
 * @LastEditTime: 2023-05-12 14:53:37
 * @Description: Shell
-->
<template>
  <div class="node-data-edit-base">
    <el-form ref="form" :model="form" :rules="rules" label-suffix=":" label-position="right" label-width="80px" class="form-content">
