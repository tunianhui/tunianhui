<template>
  <div class="uncommitted height-100per flex-column">
    <div class="uncommitted-content">
      <div class="clearfix search-group">
        <el-button class="fr ml-10" @click="refreshTableData">
          <i class="el-icon-refresh-right"></i>
        </el-button>
        <el-input
          class="fr"
          placeholder="请输入工单编号、表名称"
          v-model="selectContent"
        >
          <el-select v-model="selectPrefix" slot="prepend" placeholder="请选择">
            <el-option label="表名称" value="tableName"></el-option>
            <el-option label="工单编号" value="orderSN"></el-option>
          </el-select>
