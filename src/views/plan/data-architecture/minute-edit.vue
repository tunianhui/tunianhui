...
export default {
  ...
  created() {
    ...
    if (JSON.stringify(this.minutetData) === '{}') {
      this.ProjectForm = this.resetProjectForm()
      // this.is_disabled = false
      this.title = '新建项目'
    } else {
      this.ProjectForm.partition_code = this.minutetData.partition_code
      this.ProjectForm.partition_name = this.minutetData.partition_name
      this.ProjectForm.partition_data_type =
        this.minutetData.partition_data_type
      this.ProjectForm.partition_default_value =
        this.minutetData.partition_default_value
      this.ProjectForm.partition_desc = this.minutetData.partition_desc
      this.ProjectForm.partition_default_format =
        this.minutetData.partition_default_format
      // this.ProjectForm.space_type = this.minutetData.space_type
  ...
  methods: {
    ...
    //           editProject({
    //             ...this.ProjectForm,
    //             project_id: this.minutetData.id,
    //           }),
    //           '项目信息设置失败'
    //         )
    //         if (res) {
