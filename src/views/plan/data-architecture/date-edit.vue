  ...
  <div class="date-edit-dialog">
    ...
    >
      ...
      >
        <el-row>
          <el-col :span="24">
            <el-form-item label="业务日期参数" prop="biz_date_key">
              <span>{{ ProjectForm.biz_date_key }}</span>
            </el-form-item>
            <el-form-item label="参数值" :label-width="formLabelWidth">
              <el-select v-model="ProjectForm.biz_date_value" placeholder="请选择">
                <el-option
...
import {queryBusinessDate, editBizPartiton} from '@/api/plan/data-architecture'
...
export default {
  ...
  created() {
    ...
    if (JSON.stringify(this.datetData) === '{}') {
      this.ProjectForm = this.resetProjectForm()
      // this.is_disabled = false
      this.title = '新建项目'
    } else {
      this.ProjectForm.biz_date_key = this.datetData.biz_date_key
      this.ProjectForm.biz_date_value = this.datetData.biz_date_value
      // this.ProjectForm.project_desc = this.datetData.project_desc
      // this.ProjectForm.engine_id = this.datetData.engine_id
      // this.ProjectForm.busin_id = this.datetData.busin_id
      // this.ProjectForm.data_source_id = this.datetData.data_source_id
      // this.ProjectForm.space_type = this.datetData.space_type
