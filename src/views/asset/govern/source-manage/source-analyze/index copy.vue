            ...
            <el-col :span="12">
              <div class="table">
                ...
                <el-table :data="storeManager" height="260">
                  ...
                  <el-table-column label="分数" prop="score" show-overflow-tooltip></el-table-column>
                </el-table>
              </div>
            </el-col>
          </el-row>
            ...
            <el-col :span="12">
              <div class="table">
                ...
                <el-table :data="computeEmphasis" height="260">
                  <el-table-column label="项目" prop="projectName" show-overflow-tooltip></el-table-column>
                  <el-table-column label="负责人" prop="createdBy" show-overflow-tooltip></el-table-column>
                  <el-table-column label="项目评分" prop="comTotalPoint" show-overflow-tooltip></el-table-column>
                </el-table>
              </div>
            </el-col>
            <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    async getProjectDetail() {
      ...
      if (res) {
        this.projectData = res.data.totalList
