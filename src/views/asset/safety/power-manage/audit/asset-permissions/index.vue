 ...
 * @LastEditTime: 2022-11-02 17:53:25
 * @Description:
-->
<template>
  <section class="asset-permissions">
    <div class="head">
      ...
      <div>
        <div class="flex">
          ...
          <el-button @click="exportRecord()">查看导出记录</el-button>
    ...
    <el-card>
      <el-table ref="multipleTable"
        ...
        <el-table-column prop="field5"
                         label="账号类型"
                         width="140"></el-table-column>
        <el-table-column prop="field6"
                         label="写权限申请"
                         width="140">
        </el-table-column>
        ...
        <el-table-column label="操作"
          ...
          <template slot-scope="scope">
            <el-tooltip class="item"
                        ...
                        content="查看"
                        placement="top">
              <el-button type="text"><i class="el-icon-set-up font-14 color-btn"
                   @click="handleTransfer(row)"></i></el-button>
            </el-tooltip>
            <el-tooltip class="item"
                        effect="dark"
                        content="编辑"
              ...
              <el-button type="text"><i class="el-icon-edit-outline font-14 color-btn"
                   @click="handleEdit(scope.row)"></i></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
    ...
    <SelectFooter @checkAllChange="checkAllChange"
                  :multipleSelection="multipleSelection"
                  :tableData="tableData"
                  @batchEdit="handleTransfer"></SelectFooter>
