<template>
  <div class="data-section-power">
    <div class="" ref="quality" v-if="tableData.length">
      <div class="head">
        <div class="flex">
          <div class="page-title mr-20">数据板块权限管理</div>
        </div>
        <div>
          <div class="flex">
      ...
      <el-card class="table-record">
        <el-table :data="tableData" style="width: 100%" ref="table">
          <el-table-column prop="dataPlate" label="数据板块">
