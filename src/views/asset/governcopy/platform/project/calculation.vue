  ...
  <section class="platform-self">
    <div class="tips">
      <el-tooltip class="item" effect="dark" content="以下生产任务用到的部分输入表连续多天没有数据，这可能是非逾期的，请参看说明文档及时处理" placement="top">
        <span>该治理项扣分：<span class="count">10.11</span>分；以下生产任务用到的部分输入表连续多天没有数据，这可能是非逾期的，请参看<span class="link">说明文档</span>及时处理。</span>
      </el-tooltip>
    </div>
    <div class="mb-10">
    ...
    <el-card>
      <el-table ref="multipleTable" :data="tableData" style="width: 100%" v-loading="!!loading" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="field4" label="项目名称" sortable show-overflow-tooltip min-width="120"></el-table-column>
        <el-table-column prop="field5" label="负责人" sortable show-overflow-tooltip min-width="90"></el-table-column>
        <el-table-column prop="field6" label="健康分" sortable min-width="70">
          <template slot-scope="{row}">
