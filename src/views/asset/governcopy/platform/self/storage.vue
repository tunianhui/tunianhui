  ...
  <section class="platform-self">
    <div class="tips">
      <el-tooltip class="item" effect="dark" content="以下表内容为空，物理存储为0，请参看说明文档及时处理" placement="top">
        <span>该治理项扣分：<span class="count">1.49</span>分；以下表内容为空，物理存储为0，请参看<span class="link">说明文档</span>及时处理。</span>
      </el-tooltip>
    </div>
    <div class="mb-10">
      <div class="flex">
    ...
    <el-card>
      <el-table ref="multipleTable" :data="tableData" style="width: 100%" v-loading="!!loading" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="field4" label="负责人" sortable show-overflow-tooltip min-width="120"></el-table-column>
        <el-table-column prop="field5" label="健康分" sortable show-overflow-tooltip width="90"></el-table-column>
