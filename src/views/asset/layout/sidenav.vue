  ...
  <section :class="['msl-aside', collapse && 'msl-aside-collapsed']">
    <div class="msl-aside-main dark-loading">
      <!-- <div class="t-opreate">
        <el-select
          class="dark-input"
          popper-class="dark-popper no-arrow no-gutter"
          ...
          <ul class="popper-list">
            <li v-for="items in editComponents" :key="items.value">
              <el-popover
                ...
                :visible-arrow="false"
                popper-class="dark-popper create-popper sub-create-popper"
              >
                ...
                <ul class="popper-list">
                  <li
                    ...
                    @click.stop="createHandle(item, $event)"
                  >
                    <touch-ripple>
                      {{ item.label }}
                      <el-tooltip
      ...
      <div class="navs navs1">
        ...
        <div class="tab-pane">
          <div class="menus" v-show="menus && menus.length && !$route.path.includes('/asset/standard/edition')">
          ...
          <div :class="['nav-view', !menus || (!menus.length && 'no-nav')]" :style="{paddingLeft: !$route.path.includes('/asset/standard/edition') ? '45px' : '0px'}">
