  ...
  <div class="data-layer">
    ...
    <el-card>
      <div class="searchBox mb-15">
        ...
        ></el-input>
        <el-button type="primary" icon="el-icon-plus" @click="createdClick">新建数据层级</el-button>
      </div>
...
export default {
  ...
  methods: {
    ...
    async saveDatalevel() {
      ...
      const res = await this.$simpleAsyncTo(saveDatalevel(params))
      if (res.flag) {
        this.listAll()
      }
    },
    async delDatalevel() {
      ...
      const res = await this.$simpleAsyncTo(delDatalevel(params))
      if (res.flag) {
        this.listAll()
      }
    },
    async editDatalevel() {
      ...
      const res = await this.$simpleAsyncTo(editDatalevel(params))
      if (res.flag) {
        this.listAll()
      }
    },
    ...
    async listDatalevel() {
      ...
      const res = await this.$simpleAsyncTo(listDatalevel(params))
      if (res.list) {
