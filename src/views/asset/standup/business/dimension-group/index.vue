  ...
  <div class="dimension-group">
    ...
    <el-card>
      <div class="searchBox mb-15">
        ...
        ></el-input>
        <el-button type="primary" icon="el-icon-plus" @click="createdClick">新建维度组</el-button>
      </div>
...
export default {
  ...
  methods: {
    ...
    async saveDimGroup() {
      ...
      const res = await this.$simpleAsyncTo(saveDimGroup(params))
      if (res.flag) {
        this.listAll()
      }
    },
    async delDimGroup() {
      ...
      const res = await this.$simpleAsyncTo(delDimGroup(params))
      if (res.flag) {
        this.listAll()
      }
    },
    async editDimGroup() {
      ...
      const res = await this.$simpleAsyncTo(editDimGroup(params))
      if (res.flag) {
        this.listAll()
      }
    },
    ...
    async listDimGroup() {
      ...
      const res = await this.$simpleAsyncTo(listDimGroup(params))
      if (res.list) {
