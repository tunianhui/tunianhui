  ...
  <div class="table-type">
    ...
    <el-card>
      <div class="searchBox mb-15">
        ...
        ></el-input>
        <el-button type="primary" icon="el-icon-plus" @click="createdClick">新建表类型</el-button>
      </div>
...
export default {
  ...
  methods: {
    ...
    async saveTabletype() {
      ...
      const res = await this.$simpleAsyncTo(saveTabletype(params))
      if (res.flag) {
        this.listAll()
      }
    },
    async delTabletype() {
      ...
      const res = await this.$simpleAsyncTo(delTabletype(params))
      if (res.flag) {
        this.listAll()
      }
    },
    async editTabletype() {
      ...
      const res = await this.$simpleAsyncTo(editTabletype(params))
      if (res.flag) {
        this.listAll()
      }
    },
    ...
    async listTabletype() {
      ...
      const res = await this.$simpleAsyncTo(listTabletype(params))
      if (res.list) {
