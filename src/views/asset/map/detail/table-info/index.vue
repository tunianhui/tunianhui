<template>
  <div class="tab-info no-hover animated " v-loading="!!loading">
    <div class="animated fadeInRight table-box">
      <Table
        :tableData="tableData"
        :tableType="tableType"
        @zoneDetail="zoneDetailHandle"
        @dataSearch="dataSearchClickHandle"
        @bloodRel="bloodClickHandle">
      </Table>
      <div style="font-size:12px;color:#8c8c8c" class="mt-10 mb-10 pl-20">以下字段为主键</div>
      <Table
        :showHeader="false"
        :tableType="tableType"
      ...
      <!-- <div style="font-size:12px;color:#8c8c8c" class="mt-10 mb-10 pl-20">以下字段为分区字段</div>
      <Table
        :showHeader="false"
        :tableData="zoneFieldData"
        :tableType="tableInfoData.table_type"
        @zoneDetail="zoneDetailHandle"
        @dataSearch="dataSearchClickHandle"
        @bloodRel="bloodClickHandle">
      </Table> -->
