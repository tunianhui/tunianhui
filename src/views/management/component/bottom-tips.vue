 ...
 * @LastEditors: 大炸鹅
 * @LastEditTime: 2023-07-28 14:09:09
 * @FilePath: \智能数据构建\src\views\management\component\bottom-tips.vue
-->
<template>
...
.page-bottom-tips {
  ...
  z-index: 9;
  box-shadow: 0 -2px 4px 0 rgba(0,0,0,0.04),0 -4px 12px 0 rgba(0,0,0,0.04);
  >div:first-child {
    display: flex;
    align-items: center;
    .bottom-tips-check {
