...
//
export function getGoverDetail(data = {}) {
  return fetch({
    url: '/resGover/governEffect/getGoverDetail',
    method: 'get',
    params: data
  })
}
//
export function getStoandComGoverTrend(data = {}) {
  return fetch({
    url: '/resGover/governEffect/getStoandComGoverTrend',
    method: 'get',
    params: data
  })
}
